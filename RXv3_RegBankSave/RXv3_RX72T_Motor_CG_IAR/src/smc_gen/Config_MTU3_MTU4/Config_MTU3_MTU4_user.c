...
#define r_Config_MTU3_MTU4_CrestInterrupt(...) R_CG_ATTRIB_INTERRUPT_BANK_EI(r_Config_MTU3_MTU4_CrestInterrupt, 15, __VA_ARGS__)
#define r_Config_MTU3_MTU4_ad_interrupt(...)   R_CG_ATTRIB_INTERRUPT_BANK_EI(r_Config_MTU3_MTU4_ad_interrupt,   15, __VA_ARGS__)
