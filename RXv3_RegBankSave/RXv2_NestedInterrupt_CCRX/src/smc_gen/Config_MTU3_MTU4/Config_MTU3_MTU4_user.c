...
#define r_Config_MTU3_MTU4_tgia3_interrupt(...)    R_CG_ATTRIB_INTERRUPT_EI(r_Config_MTU3_MTU4_tgia3_interrupt,    __VA_ARGS__)
#define r_Config_MTU3_MTU4_c4_tgia4_interrupt(...) R_CG_ATTRIB_INTERRUPT_EI(r_Config_MTU3_MTU4_c4_tgia4_interrupt, __VA_ARGS__)
#define r_Config_MTU3_MTU4_tgib3_interrupt(...)    R_CG_ATTRIB_INTERRUPT_EI(r_Config_MTU3_MTU4_tgib3_interrupt,    __VA_ARGS__)
#define r_Config_MTU3_MTU4_c4_tgib4_interrupt(...) R_CG_ATTRIB_INTERRUPT_EI(r_Config_MTU3_MTU4_c4_tgib4_interrupt, __VA_ARGS__)
#define r_Config_MTU3_MTU4_c4_tciv4_interrupt(...) R_CG_ATTRIB_INTERRUPT_EI(r_Config_MTU3_MTU4_c4_tciv4_interrupt, __VA_ARGS__)
...
#pragma interrupt r_Config_MTU3_MTU4_c4_tgia4_interrupt(vect=VECT(PERIA,INTA228),fint)
#else
#pragma interrupt r_Config_MTU3_MTU4_c4_tgia4_interrupt(vect=VECT(PERIA,INTA228))
#endif
...
#pragma interrupt r_Config_MTU3_MTU4_tgib3_interrupt(vect=VECT(PERIA,INTA224),fint)
#else
#pragma interrupt r_Config_MTU3_MTU4_tgib3_interrupt(vect=VECT(PERIA,INTA224))
#endif
...
#pragma interrupt r_Config_MTU3_MTU4_c4_tgib4_interrupt(vect=VECT(PERIA,INTA229),fint)
#else
#pragma interrupt r_Config_MTU3_MTU4_c4_tgib4_interrupt(vect=VECT(PERIA,INTA229))
#endif
static void r_Config_MTU3_MTU4_c4_tgib4_interrupt(void)
{
