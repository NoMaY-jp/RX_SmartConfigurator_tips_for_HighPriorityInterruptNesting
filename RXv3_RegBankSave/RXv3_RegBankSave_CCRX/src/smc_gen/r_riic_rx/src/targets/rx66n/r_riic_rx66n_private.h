 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_riic_rx66n_private.h
 * Description  : Functions for using RIIC on RX devices. 
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * History : DD.MM.YYYY Version  Description
 *         : 22.11.2019 2.45     First Release
 **********************************************************************************************************************/
/* Guards against multiple inclusion */
#ifndef RIIC_RX66N_PRIVATE_H
    #define RIIC_RX66N_PRIVATE_H
/***********************************************************************************************************************
 Macro definitions
 **********************************************************************************************************************/
...
/*  RIIC1 Parameter check of Configuration Options */
    #if ((0U != RIIC_CFG_CH1_INCLUDED) && (1U != RIIC_CFG_CH1_INCLUDED))
        #error "ERROR - RIIC_CFG_CH1_INCLUDED - Parameter error in configures file.  "
    #endif

    #if ((0U >= RIIC_CFG_CH1_kBPS) || (400U < RIIC_CFG_CH1_kBPS))
        #error "ERROR - RIIC_CFG_CH1_kBPS - Parameter error in configures file.  "
    #endif

    #if ((0U > RIIC_CFG_CH1_DIGITAL_FILTER) || (4U < RIIC_CFG_CH1_DIGITAL_FILTER))
        #error "ERROR - RIIC_CFG_CH1_DIGITAL_FILTER - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_MASTER_MODE) && (1U != RIIC_CFG_CH1_MASTER_MODE))
        #error "ERROR - RIIC_CFG_CH1_MASTER_MODE - Parameter error in configures file.  "
    #endif

    #if (0U == RIIC_CFG_CH1_SLV_ADDR0_FORMAT)
/* Do Nothing */
    #elif (1U == RIIC_CFG_CH1_SLV_ADDR0_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR0) || (0x007F < RIIC_CFG_CH1_SLV_ADDR0))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR0 - Parameter error in configures file.  "
        #endif
    #elif (2U == RIIC_CFG_CH1_SLV_ADDR0_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR0) || (0x03FF < RIIC_CFG_CH1_SLV_ADDR0))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR0 - Parameter error in configures file.  "
        #endif
    #else
        #error "ERROR - RIIC_CFG_CH1_SLV_ADDR0_FORMAT - Parameter error in configures file.  "
    #endif

    #if (0U == RIIC_CFG_CH1_SLV_ADDR1_FORMAT)
/* Do Nothing */
    #elif (1U == RIIC_CFG_CH1_SLV_ADDR1_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR1) || (0x007F < RIIC_CFG_CH1_SLV_ADDR1))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR1 - Parameter error in configures file.  "
        #endif
    #elif (2U == RIIC_CFG_CH1_SLV_ADDR1_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR1) || (0x03FF < RIIC_CFG_CH1_SLV_ADDR1))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR1 - Parameter error in configures file.  "
        #endif
    #else
        #error "ERROR - RIIC_CFG_CH1_SLV_ADDR1_FORMAT - Parameter error in configures file.  "
    #endif

    #if (0U == RIIC_CFG_CH1_SLV_ADDR2_FORMAT)
/* Do Nothing */
    #elif (1U == RIIC_CFG_CH1_SLV_ADDR2_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR2) || (0x007F < RIIC_CFG_CH1_SLV_ADDR2))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR2 - Parameter error in configures file.  "
        #endif
    #elif (2U == RIIC_CFG_CH1_SLV_ADDR2_FORMAT)
        #if ((0x0000 > RIIC_CFG_CH1_SLV_ADDR2) || (0x03FF < RIIC_CFG_CH1_SLV_ADDR2))
            #error "ERROR - RIIC_CFG_CH1_SLV_ADDR2 - Parameter error in configures file.  "
        #endif
    #else
        #error "ERROR - RIIC_CFG_CH1_SLV_ADDR2_FORMAT - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_SLV_GCA_ENABLE) && (1U != RIIC_CFG_CH1_SLV_GCA_ENABLE))
        #error "ERROR - RIIC_CFG_CH1_SLV_GCA_ENABLE - Parameter error in configures file.  "
    #endif

    #if ((1U > RIIC_CFG_CH1_RXI_INT_PRIORITY) || (15U < RIIC_CFG_CH1_RXI_INT_PRIORITY))
        #error "ERROR - RIIC_CFG_CH1_RXI_INT_PRIORITY - Parameter error in configures file.  "
    #endif

    #if ((1U > RIIC_CFG_CH1_TXI_INT_PRIORITY) || (15U < RIIC_CFG_CH1_TXI_INT_PRIORITY))
        #error "ERROR - RIIC_CFG_CH1_TXI_INT_PRIORITY - Parameter error in configures file.  "
    #endif

    #if ((1U > RIIC_CFG_CH1_TEI_INT_PRIORITY) || (15U < RIIC_CFG_CH1_TEI_INT_PRIORITY) || \
     (RIIC_CFG_CH1_RXI_INT_PRIORITY > RIIC_CFG_CH1_TEI_INT_PRIORITY) || \
     (RIIC_CFG_CH1_TXI_INT_PRIORITY > RIIC_CFG_CH1_TEI_INT_PRIORITY))
        #error "ERROR - RIIC_CFG_CH1_TEI_INT_PRIORITY - Parameter error in configures file.  "
    #endif

    #if ((1U > RIIC_CFG_CH1_EEI_INT_PRIORITY) || (15U < RIIC_CFG_CH1_EEI_INT_PRIORITY) || \
     (RIIC_CFG_CH1_RXI_INT_PRIORITY > RIIC_CFG_CH1_EEI_INT_PRIORITY) || \
     (RIIC_CFG_CH1_TXI_INT_PRIORITY > RIIC_CFG_CH1_EEI_INT_PRIORITY))
        #error "ERROR - RIIC_CFG_CH1_EEI_INT_PRIORITY - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_TMO_ENABLE) && (1U != RIIC_CFG_CH1_TMO_ENABLE))
        #error "ERROR - RIIC_CFG_CH1_TMO_ENABLE - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_TMO_DET_TIME) && (1U != RIIC_CFG_CH1_TMO_DET_TIME))
        #error "ERROR - RIIC_CFG_CH1_TMO_DET_TIME - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_TMO_LCNT) && (1U != RIIC_CFG_CH1_TMO_LCNT))
        #error "ERROR - RIIC_CFG_CH1_TMO_LCNT - Parameter error in configures file.  "
    #endif

    #if ((0U != RIIC_CFG_CH1_TMO_HCNT) && (1U != RIIC_CFG_CH1_TMO_HCNT))
        #error "ERROR - RIIC_CFG_CH1_TMO_HCNT - Parameter error in configures file.  "
    #endif
...
/*============================================================================*/
/*----------------------------------------------------------------------------*/
/*   PORT/ICU register setting for RIIC Channel 0, 1 or 2.                   */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/*   PORT/ICU register setting for RIIC Channel 1.                            */
/*----------------------------------------------------------------------------*/
/* Sets interrupt source priority initialization. */
    #define RIIC_IPR_CH1_RXI_INIT  ((uint8_t)(0x00)) /* RXI1 interrupt source priority initialization */
    #define RIIC_IPR_CH1_TXI_INIT  ((uint8_t)(0x00)) /* TXI1 interrupt source priority initialization */

/* EEI1 interrupt source priority initialization*/
    #define RIIC_IPR_CH1_EEI_SET   ((uint8_t)(RIIC_CFG_CH1_EEI_INT_PRIORITY))
/* RXI1 interrupt source priority initialization*/
    #define RIIC_IPR_CH1_RXI_SET   ((uint8_t)(RIIC_CFG_CH1_RXI_INT_PRIORITY))
/* TXI1 interrupt source priority initialization*/
    #define RIIC_IPR_CH1_TXI_SET   ((uint8_t)(RIIC_CFG_CH1_TXI_INT_PRIORITY))
/* TEI1 interrupt source priority initialization*/
    #define RIIC_IPR_CH1_TEI_SET   ((uint8_t)(RIIC_CFG_CH1_TEI_INT_PRIORITY))

/* Sets to use multi-function pin controller. */
    #define RIIC_MPC_SDA1_INIT     ((uint8_t)(0x00))                 /* Pin function select to Hi-Z */
    #define RIIC_MPC_SCL1_INIT     ((uint8_t)(0x00))                 /* Pin function select to Hi-Z */
    #define RIIC_MPC_SDA1_ENABLE   ((uint8_t)(0x0F))                 /* Pin function select to RIIC1 SDA pin */
    #define RIIC_MPC_SCL1_ENABLE   ((uint8_t)(0x0F))                 /* Pin function select to RIIC1 SCL pin */

/* Define interrupt request registers */
    #define RIIC_IR_RXI1         (ICU.IR[IR_RIIC1_RXI1].BIT.IR)      /* RXI1 Interrupt request register */
    #define RIIC_IR_TXI1         (ICU.IR[IR_RIIC1_TXI1].BIT.IR)      /* TXI1 Interrupt request register */

/* Define interrupt request enable registers */
    #define RIIC_IER_RXI1        (ICU.IER[IER_RIIC1_RXI1].BIT.IEN2)  /* RXI1 Interrupt request enable register */
    #define RIIC_IER_TXI1        (ICU.IER[IER_RIIC1_TXI1].BIT.IEN3)  /* TXI1 Interrupt request enable register */

/* Define GroupBL1 interrupt request enable registers */
    #define RIIC_IER_EEI1_GPBL1  (ICU.GENBL1.BIT.EN29)               /* EEI1 group Interrupt request enable register */
    #define RIIC_IER_TEI1_GPBL1  (ICU.GENBL1.BIT.EN28)               /* TEI1 group Interrupt request enable register */

/* Define interrupt source priority registers */
    #define RIIC_IPR_RXI1  (ICU.IPR[IPR_RIIC1_RXI1].BYTE)            /* RXI1 Interrupt source priority register */
    #define RIIC_IPR_TXI1  (ICU.IPR[IPR_RIIC1_TXI1].BYTE)            /* TXI1 Interrupt source priority register */
...
/*----------------------------------------------------------------------------*/
/*   RIIC register setting for RIIC Channel 1 .                               */
/*----------------------------------------------------------------------------*/
    #if (0U == RIIC_CFG_CH1_TMO_ENABLE)
        #define RIIC_CH1_TMOE           ((uint8_t)(0x00))       /* Mask for ICFER.TMOE bit. */
    #elif (1U == RIIC_CFG_CH1_TMO_ENABLE)
        #define RIIC_CH1_TMOE           ((uint8_t)(0x01))       /* Mask for ICFER.TMOE bit. */
    #endif

    #if (0U == RIIC_CFG_CH1_MASTER_MODE)
        #define RIIC_CH1_MALE           ((uint8_t)(0x00))       /* Mask for RIIC1.ICFER.MALE bit. */
    #elif (1U == RIIC_CFG_CH1_MASTER_MODE)
        #define RIIC_CH1_MALE           ((uint8_t)(0x02))       /* Mask for RIIC1.ICFER.MALE bit. */
    #endif

    #if (0U == RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_NFE            ((uint8_t)(0x00))       /* Mask for RIIC1.ICFER.NFE bit. */
    #elif (1U <= RIIC_CFG_CH1_DIGITAL_FILTER) && (4U >= RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_NFE            ((uint8_t)(0x20))       /* Mask for RIIC1.ICFER.NFE bit. */
    #endif

    #if (400U < RIIC_CFG_CH1_kBPS)
        #define RIIC_CH1_FMPE           ((uint8_t)(0x80))       /* Mask for RIIC1.ICFER.FMPE bit. */
    #else
        #define RIIC_CH1_FMPE           ((uint8_t)(0x00))       /* Mask for RIIC1.ICFER.FMPE bit. */
    #endif

/* Sets ICFER */
    #define RIIC_CH1_ICFER_INIT ((uint8_t)(RIIC_CH1_TMOE | RIIC_CH1_MALE | RIIC_NALE | RIIC_SALE | \
                                       RIIC_NACKE | RIIC_CH1_NFE | RIIC_SCLE | RIIC_CH1_FMPE))

    #if (0U == RIIC_CFG_CH1_TMO_DET_TIME)
        #define RIIC_CH1_TMOS           ((uint8_t)(0x00))       /* long mode for the timeout detection time */
    #elif (1U == RIIC_CFG_CH1_TMO_DET_TIME)
        #define RIIC_CH1_TMOS           ((uint8_t)(0x01))       /* short mode for the timeout detection time */
    #endif

    #if (0U == RIIC_CFG_CH1_TMO_LCNT)
        #define RIIC_CH1_TMOL           ((uint8_t)(0x00))       /* Count is disable while the SCL is held LOW */
    #elif (1U == RIIC_CFG_CH1_TMO_LCNT)
        #define RIIC_CH1_TMOL           ((uint8_t)(0x02))       /* Count is enable while the SCL is held LOW */
    #endif

    #if (0U == RIIC_CFG_CH1_TMO_HCNT)
        #define RIIC_CH1_TMOH           ((uint8_t)(0x00))       /* Count is disable while the SCL is held HIGH */
    #elif (1U == RIIC_CFG_CH1_TMO_HCNT)
        #define RIIC_CH1_TMOH           ((uint8_t)(0x04))       /* Count is enable while the SCL is held HIGH */
    #endif

/* Sets ICMR2 */
    #define RIIC_CH1_ICMR2_INIT     ((uint8_t)(RIIC_CH1_TMOS | RIIC_CH1_TMOL | RIIC_CH1_TMOH))

/* Sets ICMR3 */
    #if (0U == RIIC_CFG_CH1_DIGITAL_FILTER) || (1U == RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_ICMR3_INIT ((uint8_t)(0x00)) /* Sets RIIC1.ICMR3(Noise Filter Stage: single-stage filter.) */
    #elif (2U == RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_ICMR3_INIT ((uint8_t)(0x01)) /* Sets RIIC1.ICMR3(Noise Filter Stage: 2-stage filter.) */
    #elif (3U == RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_ICMR3_INIT ((uint8_t)(0x02)) /* Sets RIIC1.ICMR3(Noise Filter Stage: 3-stage filter.) */
    #elif (4U == RIIC_CFG_CH1_DIGITAL_FILTER)
        #define RIIC_CH1_ICMR3_INIT ((uint8_t)(0x03)) /* Sets RIIC1.ICMR3(Noise Filter Stage: 4-stage filter.) */
    #endif
...
/* ---- RIIC1 EEI ---- */
void riic1_eei_isr(void*);

/* ---- RIIC1 TEI ---- */
void riic1_tei_isr(void*);
    #endif
