...
***********************************************************************************************************************/
volatile uint8_t   g_sci0_iic_transmit_receive_flag; /* SCI0 transmit receive flag for I2C */
volatile uint8_t   g_sci0_iic_cycle_flag;            /* SCI0 start stop flag for I2C */
volatile uint8_t   g_sci0_slave_address;             /* SCI0 target slave address */
...
* Description  : This function receives simple IIC(SCI0) data from slave device
* Arguments    : adr -
*                    slave device address
*                rx_buf -
