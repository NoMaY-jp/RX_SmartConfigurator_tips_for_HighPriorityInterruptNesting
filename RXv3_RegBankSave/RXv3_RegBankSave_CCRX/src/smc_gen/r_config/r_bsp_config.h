...
/* NOTE:
   The default settings are the same as when using RSKRX66N.
...
/* Group name.
   ...
   6N           = RX66N Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX66N" /* Generated value. Do not edit this manually */
...
/* Clock configuration options.
   ...
   BSP_CFG_BCK_DIV   = 4     : External Bus Clock (BCK)   = 
                              (((BSP_CFG_XTAL_HZ/BSP_CFG_PLL_DIV) * BSP_CFG_PLL_MUL) / BSP_CFG_BCK_DIV)  = 60MHz
...
/* Add support of nested interrupt.
 */
#include "../../smc_integration/R_RX_Nested_Interrupt/r_rx_nested_interrupt.h"

/* For Renesas RX Simulator Debugging.
 */
#include "../../smc_integration/RenesasSimDebug/sim_debug_mode_hook.h"
