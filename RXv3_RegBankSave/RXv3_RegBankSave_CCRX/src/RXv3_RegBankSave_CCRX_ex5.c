...
#pragma interrupt i_hdr_5_1(enable, bank=0)
static void i_hdr_5_1(void)
{
    long data[10];
    int i;
...
#pragma interrupt i_hdr_5_2(enable, bank=0)
static void i_hdr_5_2(void)
{
   i_fnc_4_2();
}
...
#pragma interrupt i_hdr_5_3(enable, bank=0)
static void i_hdr_5_3(void)
{
   cnt = cnt * cnt;
}
...
#pragma interrupt i_hdr_5_4(enable, bank=0)
static void i_hdr_5_4(void)
{
   cnt++;
}
