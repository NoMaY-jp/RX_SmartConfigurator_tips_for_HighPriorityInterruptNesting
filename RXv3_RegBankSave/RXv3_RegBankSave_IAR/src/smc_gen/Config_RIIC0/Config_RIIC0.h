...
Macro definitions
***********************************************************************************************************************/
#define _F6_IIC0_SCL_LOW_LEVEL_PERIOD                          (0xF6U) /* SCL clock low-level period setting */
#define _F6_IIC0_SCL_HIGH_LEVEL_PERIOD                         (0xF6U) /* SCL clock high-level period setting */
