...
/* Select the ports (SSCL0 and SSDA0) to use in SCI0 */  
    #define R_SCI_IIC_CFG_SCI0_SSCL0_PORT   '3'        /* Port Number */  
    #define R_SCI_IIC_CFG_SCI0_SSCL0_BIT    '3'        /* Bit Number  */  

    #define R_SCI_IIC_CFG_SCI0_SSDA0_PORT   '3'        /* Port Number */  
    #define R_SCI_IIC_CFG_SCI0_SSDA0_BIT    '2'        /* Bit Number  */  

/* Select the ports (SSCL1 and SSDA1) to use in SCI1 */
    #define R_SCI_IIC_CFG_SCI1_SSCL1_PORT   '3'        /* Port Number */  
    #define R_SCI_IIC_CFG_SCI1_SSCL1_BIT    '0'        /* Bit Number  */  

    #define R_SCI_IIC_CFG_SCI1_SSDA1_PORT   '2'        /* Port Number */  
