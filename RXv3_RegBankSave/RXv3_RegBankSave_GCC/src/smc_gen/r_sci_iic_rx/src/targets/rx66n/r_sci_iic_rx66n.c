...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx66n_private.h"
...
const sci_iic_ch_rom_t g_sci_iic_ch7_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPAL0.LONG, BIT22_MASK,
    &ICU.IER[IER_SCI7_TXI7].BYTE, BIT3_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENAL0.LONG, BIT22_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch8_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPAL0.LONG, BIT0_MASK,
    &ICU.IER[IER_SCI8_TXI8].BYTE, BIT5_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENAL0.LONG, BIT0_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch9_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPAL0.LONG, BIT4_MASK,
    &ICU.IER[IER_SCI9_TXI9].BYTE, BIT7_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENAL0.LONG, BIT4_MASK,
