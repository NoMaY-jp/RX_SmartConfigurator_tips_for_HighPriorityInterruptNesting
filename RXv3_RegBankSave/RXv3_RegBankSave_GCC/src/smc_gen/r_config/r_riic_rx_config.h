...
/*  RX72M: ch0, ch1, ch2 */
/*  RX72N: ch0, ch1, ch2 */
    #define RIIC_CFG_CH0_INCLUDED           (0)
    #define RIIC_CFG_CH1_INCLUDED           (1)
...
/* The priority level of the TEI, please do not lower than the priority level of TXI and RXI */
    ...
    #define RIIC_CFG_CH1_RXI_INT_PRIORITY   (2)
    #define RIIC_CFG_CH1_TXI_INT_PRIORITY   (2)
/* The priority level of the EEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH1_EEI_INT_PRIORITY   (3)
/* The priority level of the TEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH1_TEI_INT_PRIORITY   (3)
