...
*/
#define BSP_CFG_MCU_PART_MEMORY_SIZE    (0x14) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_PLL_MUL                 (25.0) /* Generated value. Do not edit this manually */
...
/* This macro is used to define the analog voltage that is supplied to the MCU (AVcc). This macro is defined in 
   ...
   NOTE: Set values appropriate for the user system.
 */
#define BSP_CFG_MCU_AVCC_MV                         (3300) /* Generated value. Do not edit this manually */
